...
public class EvenementController {
    ...
    public ResponseEntity<EvenementDto> create(@RequestBody @Valid EvenementDto dto) {
        // On passe l'ID du gestionnaire depuis le DTO
    ...
    public ResponseEntity<ReservationResponseDto> reserve(@PathVariable Long id) {
        User user = getCurrentUser();
        EvenementReservation res = service.reserveEvent(id, user.getId());
    ...
    public ResponseEntity<Void> cancelReservation(@PathVariable Long id) {
        User user = getCurrentUser();
        service.cancelReservation(id, user.getId());
    ...
    // Convertit un Evenement en EvenementDto
    ...
    // Convertit une réservation en DTO
